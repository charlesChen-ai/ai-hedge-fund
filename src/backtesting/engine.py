...
from src.tools.market import get_backtest_dates, get_default_benchmark
...
class BacktestEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._benchmark_ticker = get_default_benchmark(tickers)
    ...
    def _prefetch_data(self) -> None:
        ...
        # Preload benchmark comparison data
    ...
    def run_backtest(self) -> PerformanceMetrics:
        ...
        dates = get_backtest_dates(self._start_date, self._end_date, self._tickers)
        if len(dates) > 0:
